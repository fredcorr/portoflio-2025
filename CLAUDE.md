...
- When editing files under `apps/web/**`, also follow `apps/web/CLAUDE.md`
- When editing files under `apps/studio/**`, also follow `apps/studio/CLAUDE.md`
- Always follow the rules in this file first, then workspace rules, then `CLAUDE.md`
